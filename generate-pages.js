...
CONFIG.serviceAreas.forEach(area => {
  ...
  html = setMeta(
    html,
    `Interior & Exterior Painting in ${area.name}, ${CONFIG.stateShort} | ${CONFIG.businessName}`,
    `${CONFIG.businessName} provides interior painting, exterior painting, and commercial painting services in ${area.name}, ${CONFIG.stateShort}. Free quotes. Written warranty.`
  );
