# Houzflow Painters Website — HTML/CSS/JS Template

A fully config-driven, multi-page website for residential and commercial painting contractors. Zero dependencies, no build step required for deployment. One config file controls almost everything.
...
```js
businessName:   "ABC Painting Co.",
phone:          "(555) 123-4567",
phoneRaw:       "5551234567",       // digits only — must match phone
email:          "hello@abcpainting.com",
city:           "Austin, TX",
state:          "Texas",
stateShort:     "TX",
...
colors: {
  primary:    "#1B4332",   // swap for client's brand colour
  secondary:  "#2D3748",
},
...
2. Run `node generate-pages.js` — the new `services/deck-staining.html` is created automatically.
...
```js
colors: {
  primary:   "#1B4332",   // buttons, accents, CTAs
  secondary: "#2D3748",   // header, footer, dark sections
}
```
...
```json
{
  ...
  "source_url":    "https://abcpainting.com/?utm_source=facebook&fbclid=IwAR...",
